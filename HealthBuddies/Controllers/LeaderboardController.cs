...
namespace HealthBuddies.Controllers
{
    public class LeaderboardController : Controller
    {
        ...
        // GET: Leaderboard
        public ActionResult Index(string sortCriteria)
        {
            ...
            {
                list = list.OrderByDescending(u => u.userCurrency).ToList();
            }
            else // Default sorting by steps
            {
                list = list.OrderByDescending(u => u.dailySteps).ToList();
            }
            return View(list);
        }
